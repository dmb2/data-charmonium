...
void init_hist_book(std::map<std::string,TH1D*>& HistBook){
  ...
  HistBook["jet_z"]=new TH1D("jet_z","Jet Z;z;evts/binwidth",25,0,1.1);

  HistBook["tau1"]=new TH1D("tau1","N Subjettiness #tau_{1};#tau_{1};evts/binwidth",25,0,1.2);
  HistBook["tau2"]=new TH1D("tau2","N Subjettiness #tau_{2};#tau_{2};evts/binwidth",25,0,0.5);
  HistBook["tau3"]=new TH1D("tau3","N Subjettiness #tau_{3};#tau_{3};evts/binwidth",25,0,0.5);
  ...
  HistBook["jpsi_pt"]=new TH1D("jpsi_pt","J/#psi p_{T};p_{T} [GeV];evts/binwidth",25,0,200);
